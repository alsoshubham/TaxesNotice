...
export default function About() {
  return (
    <section className="about-section bg-[#ffffff] py-16">
      <div className="container mx-auto px-6 lg:px-20">
        <h2 className="text-4xl font-extrabold text-center text-gray-800 mb-12">
          About TaxesNotice
        </h2>
        <div className="flex flex-col gap-4 lg:flex-row items-start lg:items-center lg:justify-between">
          <div className="lg:w-1/2">
            ...
            <ul className="list-none text-gray-700 mb-6">
              <li className="flex items-center mb-2">
                <FaCheckCircle className="text-[#cdaa6d] mr-2" />
            ...
            <button className="bg-[#002d72] text-white px-6 py-3 rounded-lg shadow-md transition duration-300">
              Learn More
            </button>
          </div>
          <div className="lg:w-1/2 mt-10 lg:mt-0 grid grid-cols-2 gap-6">
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              <FaClock className="text-[#cdaa6d] text-4xl mx-auto mb-2" />
              <p className="text-3xl font-bold text-[#cdaa6d]">15+</p>
              <p className="text-gray-700 mt-2">Years of Experience</p>
            </div>
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              <FaUsers className="text-[#cdaa6d] text-4xl mx-auto mb-2" />
              <p className="text-3xl font-bold text-[#cdaa6d]">500+</p>
              <p className="text-gray-700 mt-2">Clients Served</p>
            </div>
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              <FaProjectDiagram className="text-[#cdaa6d] text-4xl mx-auto mb-2" />
              <p className="text-3xl font-bold text-[#cdaa6d]">300+</p>
              <p className="text-gray-700 mt-2">Projects Completed</p>
            </div>
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              <FaAward className="text-[#cdaa6d] text-4xl mx-auto mb-2" />
              <p className="text-3xl font-bold text-[#cdaa6d]">20+</p>
